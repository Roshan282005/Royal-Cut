...
const ServiceCardImage: React.FC<{
  ...
  // Fallback to trusted luxury grooming image if link ever fails
  const fallbackUrl = 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?auto=format&fit=crop&w=800&q=80';
