...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenBooking }) => {
  ...
  return (
    ...
    >
      {/* 1. Cinematic 3D Scene Layer (Left Barber Chair, Right Tools, Center Crest) */}
      <Hero3DCanvas />

      {/* 2. Atmospheric Studio Lighting, Radial Glows & Film Grain Vignette */}
      <div className="absolute inset-0 pointer-events-none z-10">
        ...
        {/* Side Studio Vignette to frame 3D elements */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#070709] via-transparent to-[#070709]/75" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#070709]/80 via-transparent to-[#070709]/80 hidden lg:block" />

        {/* Subtle Charcoal / Marble Atmosphere Texture */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_transparent_0%,_#070709_80%)] opacity-85" />
      </div>
