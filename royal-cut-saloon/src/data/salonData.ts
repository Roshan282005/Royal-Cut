...
export const MASTERS_DATA: MasterBarber[] = [
  {
    id: 'master-1',
    name: 'Marcus "Vito" Vance',
    role: 'Lead Master Barber & Founder',
    specialty: 'Skin Fades, Scissor Architecture & Straight Razor Rituals',
    experience: '14+ YEARS EXPERIENCE',
    avatar: 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&w=1200&q=80',
    bio: 'Trained in Milan and New York, Marcus brings architectural precision and old-world craftsmanship to modern high-end fades and classic razor shaves.',
    rating: 4.98,
    reviewCount: 342,
  ...
  },
  {
    ...
    specialty: 'Texture Styling, Tapers & Executive Beard Design',
    experience: '10+ YEARS EXPERIENCE',
    avatar: 'https://images.unsplash.com/photo-1517832606589-7929c392b5a7?auto=format&fit=crop&w=1200&q=80',
    bio: 'Specializing in tailored executive cuts and dimensional beard sculpting, AJ crafts signature looks that complement jawline anatomy.',
    rating: 4.96,
    reviewCount: 284,
  ...
  },
  {
    id: 'master-3',
    name: 'Darius Thorne',
    role: 'Color & Skin Treatment Specialist',
    specialty: 'Luxury Facials, Highlights, Scalp Therapy & Detan',
    experience: '8+ YEARS EXPERIENCE',
    avatar: 'https://images.unsplash.com/photo-1599351431202-1e0f0137899a?auto=format&fit=crop&w=1200&q=80',
    bio: 'Certified in high-end trichology and dermatological facials, Darius ensures your skin and scalp receive true five-star treatment.',
    rating: 4.95,
    reviewCount: 196,
...
export const TESTIMONIALS_DATA: TestimonialItem[] = [
  {
    ...
    role: 'Private Equity Partner, Long Island',
    quote: 'Royal Cut Saloon is hands-down the best grooming experience in New York. The attention to detail from the hot towel prep to the razor fade is unmatched. You leave feeling invincible.',
    service: 'Royal Package & Gold Facial',
    date: 'February 2026',
    rating: 5
  },
  {
    ...
    quote: 'The ambiance is breathtaking—black marble, flawless lighting, and genuine master craftsmen. Marcus took my beard from unkempt to runway-ready in under an hour.',
    service: 'Master Fade & Hot Towel Shave',
    date: 'January 2026',
    rating: 5
  },
  {
    ...
    role: 'Attorney at Law, Garden City',
    quote: 'I brought my 1-year-old for Baby\'s First Royal Cut and the experience was truly memorable. The commemorative certificate and patience of the barber were incredible.',
    service: 'Baby\'s First Royal Cut',
    date: 'January 2026',
    rating: 5
  },
  {
    ...
    role: 'Tech Executive',
    quote: 'The Ultimate Package is worth every single dollar. 3 hours of pure luxury, scalp spa, facial, and precision beard work. This is my permanent spot.',
    service: 'Ultimate Royal Experience ($180)',
    date: 'December 2025',
    rating: 5
  }
];
